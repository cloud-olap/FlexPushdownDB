...
#include <fpdb/pushdown/cache/CacheLoad.h>
#include <fpdb/pushdown/s3/S3SelectScan.h>
#include <fpdb/pushdown/s3/S3SelectScan2.h>
#include <fpdb/pushdown/merge/Merge.h>
#include <fpdb/pushdown/collate/Collate.h>
#include <fpdb/core/graph/OperatorGraph.h>
#include <fpdb/pushdown/AWSClient.h>
#include <fpdb/core/ATTIC/Normal.h>
#include <fpdb/connector/s3/S3Util.h>
#include <fpdb/connector/s3/S3SelectPartition.h>

#include "TestUtil.h"

using namespace fpdb::pushdown;
using namespace fpdb::pushdown::cache;
using namespace fpdb::pushdown::merge;
using namespace fpdb::pushdown::test;
using namespace fpdb::core;
using namespace fpdb::core::graph;
using namespace fpdb::connector::s3;
...
//  fpdb::pushdown::AWSClient client;
//  client.init();
//
//  auto n = Normal::start();
//
