...
#ifndef FPDB_FPDB_TUPLE_INCLUDE_FPDB_TUPLE_ARROW_EXEC_PARTITIONUTIL_H
#define FPDB_FPDB_TUPLE_INCLUDE_FPDB_TUPLE_ARROW_EXEC_PARTITIONUTIL_H
...
#endif //FPDB_FPDB_TUPLE_INCLUDE_FPDB_TUPLE_ARROW_EXEC_PARTITIONUTIL_H
