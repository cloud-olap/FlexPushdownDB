...
from s3filter.query.join import synthetic_join_filtered_opt
...
def main():
    ...
    settings = SyntheticFilteredJoinSettings(
        ...
        use_shared_mem=True, shared_memory_size=1 * 1024 * 1024,
    ...
    query_plan = synthetic_join_filtered_opt.query_plan(settings)
