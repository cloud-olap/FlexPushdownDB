...
def run(buffer_size):
    ...
    lineitem_scan = query_plan.add_operator(tpch_q19.sql_scan_lineitem_select_all_op(query_plan))
    part_scan = query_plan.add_operator(tpch_q19.sql_scan_part_select_all_op(query_plan))
