...
def test_join_bloom():
    ...
    part_scan = query_plan.add_operator(tpch_q19.sql_scan_part_partkey_brand_size_container_where_extra_filtered_op())
    ...
    part_bloom_create = query_plan.add_operator(tpch_q19.bloom_create_partkey_op())
