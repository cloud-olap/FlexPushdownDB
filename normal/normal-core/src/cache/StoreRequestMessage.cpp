...
std::shared_ptr<StoreRequestMessage> StoreRequestMessage::make(const std::shared_ptr<SegmentKey> &SegmentKey,
															   const std::shared_ptr<SegmentData> &SegmentData) {
  return std::make_shared<StoreRequestMessage>(SegmentKey, SegmentData);
}
...
std::string StoreRequestMessage::toString() {
