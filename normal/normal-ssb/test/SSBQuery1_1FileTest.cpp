 ...
 */
std::shared_ptr<TupleSet2> executeExecutionPlan(const std::shared_ptr<OperatorManager> &mgr) {
 ...
 */
void dateScan(const std::string &dataDir, int numConcurrentUnits, bool check) {
 ...
 * Only checking row count at moment
 */
void dateFilter(short year, const std::string &dataDir, int numConcurrentUnits, bool check) {
 ...
 * Only checking row count at moment
 */
void lineOrderScan(const std::string &dataDir, int numConcurrentUnits, bool check) {
 ...
 * Only checking row count at moment
 */
void lineOrderFilter(short discount, short quantity, const std::string &dataDir, int numConcurrentUnits, bool check) {
 ...
 * Only checking row count at moment
 */
void join(short year, short discount, short quantity, const std::string &dataDir, int numConcurrentUnits, bool check) {
 ...
 */
void aggregate(short year, short discount, short quantity,
...
TEST_CASE ("date-scan" * doctest::skip(false || SKIP_SUITE)) {
  dateScan("data/ssb-sf0.01", 1, true);
  dateScan("data/ssb-sf0.01", 2, true);
  dateScan("data/ssb-sf1", 1, true);
  dateScan("data/ssb-sf1", 2, true);
}

TEST_CASE ("lineorder-scan" * doctest::skip(false || SKIP_SUITE)) {
  lineOrderScan("data/ssb-sf0.01", 1, true);
  lineOrderScan("data/ssb-sf0.01", 2, true);
  lineOrderScan("data/ssb-sf1", 1, true);
  lineOrderScan("data/ssb-sf1", 2, true);
}

TEST_CASE ("date-filter" * doctest::skip(false || SKIP_SUITE)) {
  dateFilter(1992, "data/ssb-sf0.01", 1, true);
  dateFilter(1992, "data/ssb-sf0.01", 2, true);
  dateFilter(1992, "data/ssb-sf1", 1, true);
  dateFilter(1992, "data/ssb-sf1", 2, true);
}

TEST_CASE ("lineorder-filter" * doctest::skip(false || SKIP_SUITE)) {
  lineOrderFilter(2, 25, "data/ssb-sf0.01", 1, true);
  lineOrderFilter(2, 25, "data/ssb-sf0.01", 2, true);
  lineOrderFilter(2, 25, "data/ssb-sf1", 1, true);
  lineOrderFilter(2, 25, "data/ssb-sf1", 2, true);
}
...
TEST_CASE ("join" * doctest::skip(false || SKIP_SUITE)) {
  ::join(1992, 2, 25, "data/ssb-sf0.01", 1, true);
  ::join(1992, 2, 25, "data/ssb-sf0.01", 2, true);
  ::join(1992, 2, 25, "data/ssb-sf1", 8, false);
}
...
TEST_CASE ("aggregate" * doctest::skip(false || SKIP_SUITE)) {
  ::aggregate(1992, 2, 25, "data/ssb-sf0.01", 1, true);
  ::aggregate(1992, 2, 25, "data/ssb-sf0.01", 2, true);
  ::aggregate(1992, 2, 25, "data/ssb-sf1", 8, false);
}
