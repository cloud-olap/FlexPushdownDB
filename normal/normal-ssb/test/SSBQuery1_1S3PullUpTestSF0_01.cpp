...
TEST_CASE ("date-scan-par1" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::dateScan("ssb-sf0.01", "data/ssb-sf0.01", 1, 1, true);
}

TEST_CASE ("date-scan-par2" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::dateScan("ssb-sf0.01", "data/ssb-sf0.01", 2, 1, true);
}

TEST_CASE ("lineorder-scan-par1" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::lineOrderScan("ssb-sf0.01", "data/ssb-sf0.01", 1, true);
}

TEST_CASE ("lineorder-scan-par2" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::lineOrderScan("ssb-sf0.01", "data/ssb-sf0.01", 2, true);
}

TEST_CASE ("date-filter-par1" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::dateFilter(1992, "ssb-sf0.01", "data/ssb-sf0.01", 1, true);
}

TEST_CASE ("date-filter-par2" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::dateFilter(1992, "ssb-sf0.01", "data/ssb-sf0.01", 2, true);
}

TEST_CASE ("lineorder-filter-par1" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::lineOrderFilter(2, 25, "ssb-sf0.01", "data/ssb-sf0.01", 1, true);
}

TEST_CASE ("lineorder-filter-par2" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::lineOrderFilter(2, 25, "ssb-sf0.01", "data/ssb-sf0.01", 2, true);
}

TEST_CASE ("join-par1" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::join(1992, 2, 25, "ssb-sf0.01", "data/ssb-sf0.01", 1, true);
}

TEST_CASE ("join-par2" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::join(1992, 2, 25, "ssb-sf0.01", "data/ssb-sf0.01", 2, true);
}

TEST_CASE ("full-par1" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::full(1992, 2, 25, "ssb-sf0.01", "data/ssb-sf0.01", 1, true);
}

TEST_CASE ("full-par2" * doctest::skip(false || SKIP_SUITE)) {
  S3SelectTests::full(1992, 2, 25, "ssb-sf0.01", "data/ssb-sf0.01", 2, true);
}
