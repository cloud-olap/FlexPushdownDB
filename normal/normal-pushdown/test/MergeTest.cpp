...
std::shared_ptr<TupleSet2> makeTupleSet1() {
...
std::shared_ptr<TupleSet2> makeTupleSet2() {
  auto stringType = arrow::utf8();
...
TEST_CASE ("merge-3x3" * doctest::skip(false || SKIP_SUITE)) {

  std::shared_ptr<TupleSet2> tupleSet1 = makeTupleSet1();
  std::shared_ptr<TupleSet2> tupleSet2 = makeTupleSet2();
...
TEST_CASE ("merge-fail-duplicate-columns" * doctest::skip(false || SKIP_SUITE)) {
  ...
  std::shared_ptr<TupleSet2> tupleSet1 = makeTupleSet1();
  std::shared_ptr<TupleSet2> tupleSet2 = makeTupleSet1();
