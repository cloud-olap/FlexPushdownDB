...
#include "../../ast/S3SelectScanLogicalOperator.h"
...
S3SelectCatalogueEntry::S3SelectCatalogueEntry(const std::string& Alias,
    ...
    : CatalogueEntry(Alias, catalogue), s3Bucket_(std::move(S3Bucket)), s3Object_(std::move(S3Object)) {}
...
std::shared_ptr<ScanNode> S3SelectCatalogueEntry::toLogicalOperator() {
